...
async function captureImages(
    ...
    try {
        ...
        if (videoRef.current) {
            ...
            onCaptureComplete({
                frontImage: originalFacingMode === "user" ? firstCapture.dataUrl : secondCapture.dataUrl,
                backImage: originalFacingMode === "user" ? secondCapture.dataUrl : firstCapture.dataUrl,
